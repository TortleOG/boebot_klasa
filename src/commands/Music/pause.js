...
module.exports = class extends Command {
	...
	async run(msg) {
		...
		else if (msg.guild.voiceConnection.dispatcher.paused) throw `❌ | ${msg.author}, the stream is already paused. Use \`${msg.guild.settings.prefix}resume\` to resume the song.`;
